...
public class Health extends AppCompatActivity implements OnItemClickListener {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(Health.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://skolage.com/buyon/health.json");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new Adapter_(Health.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(Health.this));

                mRVFishPrice.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {

                    GestureDetector gestureDetector = new GestureDetector(Health.this, new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                        ...
                        if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                            ...
                            Intent i=new Intent(Health.this,WebActivity.class);
                ...
                Toast.makeText(Health.this, e.toString(), Toast.LENGTH_LONG).show();
            }
