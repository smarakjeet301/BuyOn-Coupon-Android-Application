...
public class Food extends AppCompatActivity implements OnItemClickListener {
...
private class AsyncFetch extends AsyncTask<String, String, String> {
    ProgressDialog pdLoading = new ProgressDialog(Food.this);
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            url = new URL("https://skolage.com/buyon/food.json");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            mAdapter = new Adapter_(Food.this, data);
            mRVFishPrice.setAdapter(mAdapter);
            mRVFishPrice.setLayoutManager(new LinearLayoutManager(Food.this));

            mRVFishPrice.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {

                GestureDetector gestureDetector = new GestureDetector(Food.this, new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                    ...
                    if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                        ...
                        Intent i=new Intent(Food.this,WebActivity.class);
            ...
            Toast.makeText(Food.this, e.toString(), Toast.LENGTH_LONG).show();
        }
