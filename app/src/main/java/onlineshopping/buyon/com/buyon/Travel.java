...
public class Travel extends AppCompatActivity  implements OnItemClickListener {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(Travel.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://skolage.com/buyon/travel.json");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new Adapter_(Travel.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(Travel.this));

                mRVFishPrice.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {

                    GestureDetector gestureDetector = new GestureDetector(Travel.this, new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                        ...
                        if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                            ...
                            Intent i=new Intent(Travel.this,WebActivity.class);
                ...
                Toast.makeText(Travel.this, e.toString(), Toast.LENGTH_LONG).show();
            }
