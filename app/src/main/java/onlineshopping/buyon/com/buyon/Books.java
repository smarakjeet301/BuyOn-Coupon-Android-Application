...
public class Books extends AppCompatActivity implements OnItemClickListener {
...
private class AsyncFetch extends AsyncTask<String, String, String> {
    ProgressDialog pdLoading = new ProgressDialog(Books.this);
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            url = new URL("https://skolage.com/buyon/books.json");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            mAdapter = new Adapter_(Books.this, data);
            mRVFishPrice.setAdapter(mAdapter);
            mRVFishPrice.setLayoutManager(new LinearLayoutManager(Books.this));

            mRVFishPrice.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {

                GestureDetector gestureDetector = new GestureDetector(Books.this, new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                    ...
                    if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                        ...
                        Intent i=new Intent(Books.this,WebActivity.class);
            ...
            Toast.makeText(Books.this, e.toString(), Toast.LENGTH_LONG).show();
        }
