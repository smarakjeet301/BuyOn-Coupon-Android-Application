...
public class Grocery extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Grocery.AsyncFetch().execute();
    }
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(Grocery.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://skolage.com/buyon/grocery.json");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new Adapter_(Grocery.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(Grocery.this));

                mRVFishPrice.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {

                    GestureDetector gestureDetector = new GestureDetector(Grocery.this, new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                        ...
                        if(ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                            ...
                            Intent i=new Intent(Grocery.this,WebActivity.class);
                ...
                Toast.makeText(Grocery.this, e.toString(), Toast.LENGTH_LONG).show();
            }
